...
pub const SYNTAX_NODES: &'_ [SyntaxNode<'_>] = &[
    ...
    S!("cursor_declaration_stmt", "A node that marks a full cursor declaration statement"),
    S!("cursor_definition_stmt", "A node that marks a full cursor definition statement"),
    ...
    S!("exclam", "An exclamation mark `!`"),    S!("execute_immediate_stmt", "A node that contains a full EXECUTE IMMEDIATE statement"),
